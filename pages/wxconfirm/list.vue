<!--
 * @Descripttion: 维修确认单列表
 * @Author: jsw丶郁
 * @Date: 2022-04-02 17:00:24
 * @LastEditors: jsw丶郁
 * @LastEditTime: 2022-05-10 15:20:25
-->
<template>
  <view class="confirm-wrap">
    <!--维修确认头部的查询-->
    <view class="confirm-search">
...
export default {
  components: { SimpleSearch, MineView, MineBadge, MineGoodsView },
  mixins: [func],
  data() {
    return {
      confirmList: [],
