 ...
 * @Descripttion: 悬浮球组件
 * @Author: jsw丶郁
 * @Date: 2022-05-05 16:31:37
 * @LastEditors: jsw丶郁
 * @LastEditTime: 2022-05-10 09:31:52
-->
<template>
  <view
  ...
  >
    <view class="wave">
      <image src="../../static/images/custom.png"></image>
    </view>
  </view>
</template>
...
export default {
  ...
  created() {
    ...
    _this.top = _this.modile.screenHeight / 2;
  ...
  methods: {
    ...
    finish(e) {
      ...
      if (
        _this.top >
        _this.modile.safeArea.height + _this.modile.safeAreaInsets.bottom
      ) {
        _this.top =
          _this.modile.safeArea.height + _this.modile.safeAreaInsets.bottom;
    ...
    makePhone() {
      uni.makePhoneCall({
        phoneNumber: uni.getStorageSync("customTel"),
      });
    },
  },
};
